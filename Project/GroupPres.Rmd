...
model_df <- select(df, c(sleep_h, age, exper, hrwage, yrsmarr, spsepay, male, gdhlth, totwrk))
model <- lm(sleep_h~age+exper+I(log(hrwage))+yrsmarr+spsepay+male+gdhlth+totwrk, df)
```
...
>>>>>>> fcf372bdbe7e64a7fade3fc4700caec99a846727
=======
## Classical Linear Model (CLM) Assumptions
>>>>>>> fcf372bdbe7e64a7fade3fc4700caec99a846727
